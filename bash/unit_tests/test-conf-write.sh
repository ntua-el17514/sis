...
home_dir="."
key_name="slurm.key"
cert_name="slurm.cert"

echo "ControlMachine=node001
AuthType=auth/none
CacheGroups=0
...
# COMPUTE NODES
NodeName=node[001-002] CPUs=20 Sockets=2 CoresPerSocket=10 ThreadsPerCore=1 RealMemory=57344 State=UNKNOWN" > $home_dir/etc/slurm.conf.template
